<!-- This page accepts the card id of patient to display the report of that patient to junior doctor -->
...
<title>junior doctor patient</title>
	...
	<div id="main_container">
		<div class="header">
			...
			<div class="middle_box2" style="background-color: white">
				<div class="middle_box_content">
					<center>Welcome to Junior Doctor Page.</center>
					<form method="post" action="/EyeCare/ViewReportToJuniorDoctor">
						<table align="center">
							<tr>
