<!-- This page displays form to edit patient details as age,address and mobile number -->
	...
	<div id="main_container">
		<div class="header">
			...
			<div class="middle_box2" style="background-color: white">
				<div class="middle_box_content">
					<center>Welcome to Edit Details.</center>
					<form action="/EyeCare/EditDetailsForm" method="post">
