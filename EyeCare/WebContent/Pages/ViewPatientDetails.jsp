<!-- This page displays the details of patient -->
	...
	<div id="main_container">
		<div class="header">
			...
			<div class="middle_box2" style="background-color: white">
				<div class="middle_box_content">
					<center>Welcome to ViewDetails Page.</center>

					<form action="/EyeCare/ViewPatientDetails" method="post">
						<table align="center">
							<tr>
							...
							<tr>
								<td colspan="2"><input type="Submit" value="ViewDetails"
