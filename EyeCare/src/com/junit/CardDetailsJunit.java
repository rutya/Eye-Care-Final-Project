...
public class CardDetailsJunit {
	...
	public void testGetAllCardDetails() {
		...
		CardDetailsDao dao=new CardDetailsDaoimpl();
		int patientdetails=dao.getAllCardDetails().size();
	...
	public void testAddCardDetail() throws CardDetailsExistsException {
		...
		int actual=dao.getAllCardDetails().size();
		expected=expected+1;
	...
	public void testUpdateCardDetails() {
		...
		CardDetails card=dao.getCardDetails(4);
